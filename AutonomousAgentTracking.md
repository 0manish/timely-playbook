...
| --- | --- | --- | --- |
| **Control ledger (`timely-trackers/agent-control-ledger.md`)** | Single source of truth for which agents own milestones, their operating parameters, and escalation paths. | Under `timely-trackers/`. | [templates/agent-execution-tracker.md](templates/agent-execution-tracker.md) |
| **Quality journal (`timely-trackers/test-run-journal.md`)** | Rolling log of scheduled and manual validation runs with links to evidence. | Under `timely-trackers/`. | [templates/test-run-journal.md](templates/test-run-journal.md) |
| **Spec traceability matrix (`timely-trackers/spec-traceability.md`)** | Connects governance requirements to implementation and validation. | Under `timely-trackers/`. | [templates/spec-traceability-matrix.md](templates/spec-traceability-matrix.md) |
...
| **Living TODO / OKR board (`timely-trackers/todo-backlog.md`)** | Captures unassigned TODOs, risks, and quarterly objectives to seed agent pickup lists. | Under `timely-trackers/`. | [templates/todo-backlog.md](templates/todo-backlog.md) |
