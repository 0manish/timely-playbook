...
| Medium | Add one fully documented non-Codex provider example and record the operator steps for `fullstack-run --provider` plus `TIMELY_AUTOFIX_COMMAND` | TimelyPlaybook.md | Smoke Test | 2026-03-28 | Done |
