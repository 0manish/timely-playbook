...
class PlaybookPackagingTests(unittest.TestCase):
    ...
    def test_packaged_template_bootstrap_script_seeds_repo(self) -> None:
        ...
        self.assertTrue((template_dir / ".timely-playbook" / "bin" / "claude-code-example.sh").exists())
        self.assertTrue((template_dir / ".timely-playbook" / "bin" / "open-source-agent-example.sh").exists())
        self.assertTrue((template_dir / ".timely-playbook" / "bin" / "symphony-submit.sh").exists())
        ...
        self.assertTrue((seeded_dir / ".timely-playbook" / "bin" / "claude-code-example.sh").exists())
        self.assertTrue((seeded_dir / ".timely-playbook" / "bin" / "open-source-agent-example.sh").exists())
        self.assertTrue((seeded_dir / ".timely-playbook" / "bin" / "symphony-submit.sh").exists())
    ...
    def test_packaged_template_keeps_placeholders_and_version_files(self) -> None:
        ...
        self.assertTrue((extracted / ".timely-playbook" / "bin" / "claude-code-example.sh").exists())
        self.assertTrue((extracted / ".timely-playbook" / "bin" / "open-source-agent-example.sh").exists())
        self.assertTrue((extracted / ".timely-playbook" / "bin" / "symphony-submit.sh").exists())
