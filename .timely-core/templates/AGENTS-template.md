...
## Scope
Describe the directory this file governs (for example
`.timely-playbook/local/timely-trackers/`, `.timely-core/cmd/`,
`.timely-core/tools/`, or `web/`). Mention any subdirectories explicitly
...
- Point to the
  [spec traceability matrix](../../.timely-playbook/local/timely-trackers/spec-traceability.md)
  and note how to add entries.
