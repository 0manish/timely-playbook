...
| --- | --- | --- | --- | --- | --- | --- |
| <!-- GOV-TEMPLATE-001 --> | <!-- AGENTS.md#template-purpose --> | <!-- `timely-playbook package` --> | <!-- `.timely-core/cmd/timely-playbook/main.go` --> | <!-- `python -m unittest discover -s .timely-core/tests -p 'test_*.py'` --> | <!-- In Progress --> | <!-- Traceability comments --> |
